#############################################################################
# Makefile for building: jordanazoulaybdd
# Generated by qmake (3.0) (Qt 5.5.0)
# Project:  jordanazoulaybdd.pro
# Template: app
# Command: /opt/Qt/5.5/gcc_64/bin/qmake -spec linux-g++ -o Makefile jordanazoulaybdd.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = jordanazoulaybdd1.0.0
DISTDIR = /home/dev0/Documents/jordanazoulaybdd/.tmp/jordanazoulaybdd1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/opt/Qt/5.5/gcc_64
LIBS          = $(SUBLIBS)  
AR            = ar cqs
RANLIB        = 
SED           = sed
...
DIST          = /opt/Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		...
		jordanazoulaybdd.pro tools.h main.c
QMAKE_TARGET  = jordanazoulaybdd
DESTDIR       = #avoid trailing-slash linebreak
TARGET        = jordanazoulaybdd
...
Makefile: jordanazoulaybdd.pro /opt/Qt/5.5/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt/5.5/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt/5.5/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt/5.5/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt/5.5/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt/5.5/gcc_64/mkspecs/common/gcc-base.conf \
		...
		/opt/Qt/5.5/gcc_64/mkspecs/features/yacc.prf \
		/opt/Qt/5.5/gcc_64/mkspecs/features/lex.prf \
		jordanazoulaybdd.pro
	$(QMAKE) -spec linux-g++ -o Makefile jordanazoulaybdd.pro
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/jordanazoulaybdd/bin || mkdir -p $(INSTALL_ROOT)/opt/jordanazoulaybdd/bin
	-$(INSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/jordanazoulaybdd/bin/$(QMAKE_TARGET)
	-$(STRIP) $(INSTALL_ROOT)/opt/jordanazoulaybdd/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/jordanazoulaybdd/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/jordanazoulaybdd/bin/ 
